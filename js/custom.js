...
var CURRENT_URL = window.location.href.split('#')[0].split('?')[0],
    ...
    $SIDEBAR_MENU = $('#navbarSupportedContent'),
...
$(function () {
    ...
    var sections = $('section'),
        ...
        typed = new Typed('.type', {
            strings: ["Data Scientist.", "Technology Consultant.", "Financial and Tax Data Expert."], /* Here Type Your Title */
            typeSpeed: 100,
            loop: true,
            backDelay: 1200,
            backSpeed: 20
...
// SCROLL TO SECTION CLICK EVENTS

$("#home").click(function() {
    $('html,body').animate({
        scrollTop: $("#home-cont").offset().top},
        'slow');
});
...
$("#about-cont2").click(function() {
    $('html,body').animate({
        scrollTop: $("#about-me-div").offset().top},
        'slow');
        return false;
});
...
$("#cv-button").click(function() {
    $('html,body').animate({
        scrollTop: $("#cv-cont").offset().top},
        'slow');
});

$("#ambitions-button").click(function() {
    $('html,body').animate({
        scrollTop: $(".ambitions").offset().top},
        'slow');
});

$("#tech-demo-button").click(function() {
    $('html,body').animate({
        scrollTop: $("#technology-demo-cont").offset().top},
        'slow');
});
